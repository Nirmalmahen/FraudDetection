...
import com.payment.gateway.mapper.UserRowMapper;
...
public class UserRepository {
    ...
    public void updateUser(User user) {
        String sql = String.format("UPDATE %s SET balance = %f WHERE username = '%s'", "users", user.getBalance(), user.getUsername());
        try {
